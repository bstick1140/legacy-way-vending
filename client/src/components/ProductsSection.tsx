...
export default function ProductsSection() {
  ...
  return (
    <section id="products" className="py-20 lg:py-28 bg-[oklch(0.95_0.018_85)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex bg-[oklch(0.90_0.018_85)] rounded-xl p-1.5 gap-1 shadow-inner">
            {tabs.map((tab) => {
              const Icon = tab.icon;
                ...
                <button
                  ...
                  className={`flex items-center gap-2.5 px-6 py-3 rounded-lg font-body font-semibold text-sm transition-all duration-200 ${
                    isActive
                      ...
                      : "text-[oklch(0.38_0.008_60)] hover:text-[oklch(0.28_0.09_155)] hover:bg-white"
                  }`}
                >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {active.categories.map((cat) => (
                <div
                  key={cat.name}
                  className="bg-white rounded-xl border border-[oklch(0.90_0.018_85)] p-6 shadow-sm hover:shadow-md transition-shadow"
                >
