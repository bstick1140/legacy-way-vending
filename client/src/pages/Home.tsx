    ...
    const schemas = [
      {
        ...
        data: {
          ...
          mainEntity: [
            ...
            { "@type": "Question", name: "How quickly can we get a healthy vending machine installed at our school?", acceptedAnswer: { "@type": "Answer", text: "Your machine is custom-built in the USA 🇺🇸 for your location. Most facilities are up and running within 9 weeks of approval." } },
