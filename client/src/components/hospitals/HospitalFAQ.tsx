...
export const hospitalFaqs = [
  ...
  },
  {
    ...
    answer:
      "Your facility needs a minimum of 300 daily staff, patients, and visitors combined. Most hospitals, medical centers, and larger clinics qualify easily. We serve facilities in Greenville, Spartanburg, Pickens, and Cherokee counties in South Carolina.",
  },
  {
