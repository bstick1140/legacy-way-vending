      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mb-16">
          ...
          <p className="font-body text-[oklch(0.44_0.04_145)] text-lg leading-relaxed">
            Getting a free healthy vending machine for your school in Upstate South Carolina is easier than you think. From qualification to installation, we handle everything for schools in Greenville, Spartanburg, Pickens, York, and Cherokee counties.
          </p>
        </div>
