      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="font-body text-white/90 text-lg">
            Answer 3 quick questions to find out if your hospital or clinic in Greenville, Spartanburg, Pickens, or Cherokee County, SC qualifies for a free, state-of-the-art healthy vending machine.
          </p>
        </div>
              ...
              <div>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  ...
                  <p className="font-body text-[oklch(0.55_0.008_60)] text-xs text-center">
                    We currently serve Greenville, Spartanburg, Pickens, and Cherokee counties in South Carolina. Outside our area? Submit anyway and we will connect you with a Free Healthy Vending representative near you.
                  </p>
              ...
              <div className="text-center py-6">
                ...
                {outOfState ? (
                  <p className="font-body text-[oklch(0.45_0.008_60)] text-base max-w-sm mx-auto">
                    Legacy Way Vending currently serves Greenville, Spartanburg, Pickens, and Cherokee counties in South Carolina. We will review your request for {formData.facilityName} and connect you with a Free Healthy Vending representative in {formData.state} within 1 business day.
                  </p>
                ) : (
                  <p className="font-body text-[oklch(0.45_0.008_60)] text-base max-w-sm mx-auto">
