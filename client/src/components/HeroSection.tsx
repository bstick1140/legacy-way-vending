          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2.5">
              {[
                ...
                "Free AI smart coolers for the teachers' lounge",
            ...
            <p className="font-body text-[oklch(0.45_0.008_60)] text-sm">
              Proudly serving <strong className="text-[oklch(0.58_0.16_145)]">Upstate South Carolina</strong> — Greenville, Spartanburg, Gaffney, Greer, Boiling Springs, Simpsonville, Mauldin & surrounding areas
            </p>
          </div>
