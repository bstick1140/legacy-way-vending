      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="font-display font-bold text-[oklch(0.28_0.10_145)] text-3xl sm:text-4xl lg:text-5xl leading-tight mb-4">
            ...
            Free Healthy Vending services are used successfully in hospitals and medical facilities across the country, including facilities in Greenville, Spartanburg, Pickens, and Cherokee counties, SC. Here is why facilities directors and operations managers choose this program.
          </p>
        </div>
