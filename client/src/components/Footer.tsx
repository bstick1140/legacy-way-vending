        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-white/80 text-sm">
                ...
                Upstate South Carolina — Greenville, Spartanburg, Pickens & Cherokee counties
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li className="pt-2 border-t border-[oklch(0.58_0.16_145)] mt-2">
                <Link href="/privacy-policy/" className="font-body text-white/80 hover:text-white transition-colors text-sm">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms-of-service/" className="font-body text-white/80 hover:text-white transition-colors text-sm">
                  Terms of Service
                </Link>
              </li>
            </ul>
