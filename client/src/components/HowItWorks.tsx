...
export default function HowItWorks() {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="py-20 lg:py-28 bg-[oklch(0.98_0.012_85)]"
    >
          ...
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Card */}
                <div className="bg-white rounded-xl p-6 shadow-sm border border-[oklch(0.90_0.018_85)] hover:shadow-md hover:border-[oklch(0.28_0.09_155/0.3)] transition-all duration-300 h-full">
                  {/* Number + Icon */}
