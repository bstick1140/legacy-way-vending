...
const steps = [
  ...
  },
  {
    ...
    description:
      "Our team delivers, installs, and sets up your brand-new state-of-the-art machine — completely free. No equipment fees, no installation charges. Installation typically takes approximately 9 weeks from approval, though timing may vary.",
  },
  {
    number: "03",
    icon: RefreshCw,
